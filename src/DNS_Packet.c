...
void print_DNS(DNS_PACKET dns_packet)
{
  ...
  printf("header.qdcount:             %02x %02x\n", (header.qdcount  >> 8) & 0xFF, 
                                                    (header.qdcount  >> 0) & 0xFF);
  printf("header.ancount:             %02x %02x\n", (header.ancount  >> 8) & 0xFF, 
                                                    (header.ancount  >> 0) & 0xFF);
  printf("header.nscount:             %02x %02x\n", (header.nscount  >> 8) & 0xFF, 
                                                    (header.nscount  >> 0) & 0xFF);
  printf("header.arcount:             %02x %02x\n", (header.arcount  >> 8) & 0xFF, 
                                                    (header.arcount  >> 0) & 0xFF);
